function initMap() {
    ...
    downloadUrl('http://localhost/projetos/LPT/src/php/pontos.php', function(data){
...
function loadScript(){
    ...
    script.src='http://maps.googleapis.com/maps/api/js?key=AIzaSyAIMLIjPd7Zzcs33jQO1XdGL0-PDXjir8M&callback=initMap';
